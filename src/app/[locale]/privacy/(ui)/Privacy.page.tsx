			...
			<div className='container mx-auto px-4 py-8'>
				...
				<p className='mb-4'>
					...
					<span className='text-yellow-5'>
						ИП Горлачевым Сергеем Руслановичем
					</span>{' '}
					(далее — Оператор).
				</p>
				...
				<ul className='list-disc ml-6 mb-4'>
					<li>
						<b>2.1.</b> Автоматизированная обработка персональных данных —
						обработка персональных данных с помощью средств вычислительной
						техники.
					</li>
					<li>
						<b>2.2.</b> Блокирование персональных данных — временное прекращение
					...
					<li>
						<b>2.4.</b> Информационная система персональных данных —
					...
					<li>
						<b>2.5.</b> Обезличивание персональных данных — действия, в
					...
					<li>
						<b>2.6.</b> Обработка персональных данных — любое действие
					...
					<li>
						<b>2.8.</b> Персональные данные — любая информация, относящаяся
				...
				<ul className='list-disc ml-6 mb-4'>
					...
					<li>
						<b>4.3.</b> Лица, передавшие Оператору недостоверные сведения о
				...
				<ul className='list-disc ml-6 mb-4'>
					<li>
						<b>5.1.</b> Обработка персональных данных осуществляется на законной
					...
					<li>
						<b>5.6.</b> При обработке персональных данных обеспечивается
				...
				<ul className='list-disc ml-6 mb-4'>
					...
					<li>
						<b>7.3.</b> Обработка персональных данных необходима для
					...
					<li>
						<b>7.5.</b> Обработка персональных данных необходима для
					...
					<li>
						...
						публикации или обязательному раскрытию в соответствии с федеральным
						законом.
					</li>
				</ul>
				<h2 className='text-2xl font-bold text-decor-2 mb-4'>
				...
				<ul className='list-disc ml-6 mb-4'>
					...
					<li>
						<b>8.5.</b> Вся информация, которая собирается сторонними сервисами,
