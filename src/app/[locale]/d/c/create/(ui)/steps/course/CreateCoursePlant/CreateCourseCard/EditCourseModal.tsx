...
const EditCourseModal = ({ isOpen, onClose, data, onSave, type, t }) => {
	...
	return (
		<Modal size='lg' color='white' isOpen={isOpen} onOpenChange={onClose}>
						...
						<ModalBody>
							<div className='flex justify-between items-start'>
								<div className='flex justify-end items-center w-[80%]'>
									<h1 className='text-medium font-medium text-[#828282] mr-3 w-[25%] text-end'>
										{promptText}
									</h1>
									<Textarea
										placeholder={t(
							...
							<div className='flex justify-between items-start'>
								<div className='flex justify-end items-center w-[80%]'>
									<h1 className='text-medium font-medium text-[#828282] mr-3 w-[25%]'>
										{t('description')}
									</h1>
									<Textarea
										placeholder={t(
