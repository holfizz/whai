...
import {getDashboardRoute, getSettingsRoute, getSupportRoute,} from '@/shared/const/router'
      ...
      <NavbarContent justify='end'>
        ...
        <Popover color={'peach'} placement="bottom-end">
          ...
          <PopoverContent className={cls.popoverContent} color={'peach'}>
            <Button className={cls.popoverButton} fullWidth color={'softPeach'} endContent={<X />}>adasdas</Button>
            <Button className={cls.popoverButton} fullWidth color={'softPeach'} endContent={<X />}>adasdas</Button>
            <Button className={cls.popoverButton} fullWidth color={'softPeach'} endContent={<X />}>adasdas</Button>
          </PopoverContent>
        </Popover>
